...
public:
    ...
    static juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout(); //core

    juce::AudioProcessorValueTreeState apvts{*this, nullptr, "Parameters", createParameterLayout() }; //core
